    ...
    if request.method == 'POST':
        ...
        if classify_message(txt) == 1:
            ...
            try:
                ...
                tel_send_message(chat_id,"Sorry. I did not get that. Try Again.")
        else:
            try:
                set_diagnosis(chat_id,txt)
                tel_send_message(chat_id,reply_diagnosis(get_diagnosis(chat_id))) 
            except:
                tel_send_message(chat_id,"I'm still working to support your query") 
